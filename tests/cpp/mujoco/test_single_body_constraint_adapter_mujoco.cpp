...
TEST( TestLocoMujocoConstraintAdapter, TestLocoMujocoConstraintAdapterBuild )
{
    ...
    // Revolute constraint
    {
        auto body = scenario->CreateBox( "pole_0", loco::TVec3(), loco::TMat3(), { 0.2f, 0.2f, 1.0f } );
    ...
    {
        auto body = scenario->CreateBox( "platform_0", loco::TVec3(), loco::TMat3(), { 1.0f, 1.0f, 0.2f } );
    ...
    {
        auto body = scenario->CreateCapsule( "rod_0", loco::TVec3(), loco::TMat3(), 0.1f, 1.0f );
    ...
    {
        auto body = scenario->CreateSphere( "sphere_0", loco::TVec3(), loco::TMat3(), 0.1f );
    ...
    {
        auto body = scenario->CreateSphere( "sphere_1", loco::TVec3(), loco::TMat3(), 0.1f );
    ...
    // Planar constraint
    {
        auto body = scenario->CreateSphere( "sphere_2", loco::TVec3(), loco::TMat3(), 0.1f );
